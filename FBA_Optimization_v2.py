...
class FBA_Optimization_v2(FloatProblem):
    pass

    def __init__(self, obj_reactions, cell: MetabolismDefinition= None, name = 'ObjReactions Optimization FBA Model'):
        super(FBA_Optimization_v2, self).__init__()
        ...
        self.number_of_objectives = len(obj_reactions)      
