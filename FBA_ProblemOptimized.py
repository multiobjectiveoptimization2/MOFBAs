...
class FBA_ProblemOptimized(FloatProblem):
    pass

    def __init__(self, obj_reactions, ref_point = [], cell: MetabolismDefinition= None, name = 'HV + DG Optimization FBA Model'):
        super(FBA_ProblemOptimized, self).__init__()
    ...
    def evaluate(self, solution: FloatSolution) -> FloatSolution:
        ...
        solution.objectives[0] = -1*H
        solution.objectives[1] = DG
        return solution
